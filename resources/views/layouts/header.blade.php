    <header class="main-header">
        ...
        @endphp
        <span class="logo-mini"><strong>{{ $word }}</strong></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><strong>{{ $setting->nama_perusahaan }}</strong></span>
        </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <small>Mendaftar Sejak, {{ tanggal_indonesia(auth()->user()->created_at) }}</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
